...
final List<ProductsModel> products = [
  ProductsModel(
    ...
    price: 433800,
    size: 24,
    // data yg udh di konversi menjadi string
    // --> "433800"
    ...
    color: const Color.fromARGB(255, 249, 241, 225)),
  ProductsModel(
    id: 2,
    title: "FuelCell Rebel v5",
    price: 349500,
    size: 12,
    ...
    color: const Color.fromARGB(255, 220, 243, 230)),
  ProductsModel(
    id: 3,
    title: "Fresh Foam X More v6",
    price: 425500,
    size: 20,
    ...
    color: const Color.fromARGB(255, 191, 199, 233)),
  ProductsModel(
    id: 4,
    title: "FuelCell 4040 v8",
    price: 578000,
    size: 40,
